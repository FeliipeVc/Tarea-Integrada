...
public class Main {
    ...
    /**
     * @param dni
     * @return Si el formato del dni es correcto
     * @author Felipe Vargas Contreras
     */
     ...
     * 
     * @param telefono
     * @return Si el formato del telefono es correcto
     * @author Felipe Vargas Contrera
     */
     ...
     * 
     * @param fecha
     * @return Si el formato de la fecha es correcto
     * @author Felipe Vargas Contreras
     */
     ...
     * 
     * @param matricula
     * @return Si el formato de la matricula es correcto
     * @author Felipe Vargas Contreras
     */
     ...
     * 
     * @param nombre
     * @return Si el formato del nombre es correcto
     * @author David Garcia Terrel
     */
     ...
     * 
     * @param apellidos
     * @return Si el formato de los apellidos es correcto
     * @author David Garcia Terrel
     */
     ...
     * 
     * @param c
     * @return Si el formato del codigo postal es correcto
     * @author David Garcia Terrel
     */
     ...
     * 
     * @param n
     * @return Si el numero de la calle es correcto
     * @author David Garcia Terrel
     */
     ...
     * 
     * @param p
     * @return Si el numero de planta es correcto
     * @author David Garcia Terrel
     */
     ...
     * 
     * @param letra
     * @return Si la letra del portal es correcta
     * @author David Garcia Terrel
     */
     ...
     * @param deficiente
     * @param grave
     * @return Comprueba que la puntuación del examen práctico sea correcta
     * @author David Garcia Terrel
     */
     ...
     * 
     * @param fallos
     * @return Comprueba que la ptuación del examen teorico sea correcta
     * @author David Garcia Terrel
     */
     ...
     * 
     * @param correo
     * @return Si el formato del correo es correcto
     * @author David Garcia Terrel
     */
     ...
     * 
     * @param marca
     * @return valida el formato de la marca sea correcto
     * @author David Garcia Terrel
     */
    ...
    /**
     * 
     * @return Si la operacion es correcta
