...
public class BD_Autoescuela extends BD_Conector {
     ...
     * 
     * @param dni
     * @return Vector Clases del profesor
     * @throws ErrorBaseDatos
     * @author Hugo Pozuelo Martinez
     */
     ...
     * 
     * @param dni
     * @return Vector Examenes del profesor
     * @throws ErrorBaseDatos
     * @author Hugo Pozuelo Martinez
     */
     ...
     * 
     * @param a1
     * @return El numero de filas que se han insertado
     * @throws ErrorBaseDatos
     * @author David Garcia Terrel
     * @author Felipe Vargas Contreras
     */
     ...
     * 
     * @param dni
     * @return El numero de filas que se han borrado
     * @throws ErrorBaseDatos
     * @author Hugo Pozuelo Martinez
     */
     ...
     * @param dni
     * @param clave
     * @return Si se ha iniciado sesion o no
     * @throws ErrorBaseDatos
     * @author Hugo Pozuelo Martinez
     */
     ...
     * 
     * @param dni
     * @return Si el alumno ha realizado suficientes clases
     * @throws ErrorBaseDatos
     * @author Felipe Vargas Contreras
     */
